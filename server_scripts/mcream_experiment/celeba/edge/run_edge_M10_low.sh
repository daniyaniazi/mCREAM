...
echo "=============================================="
echo "mCREAM: Edge (M=10, Low) - CELEBA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Edge aggregation (M=10, low)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/edge/edge_M10_low.yaml
