...
DAG_CSV="$PROJECT_ROOT/data/CelebA/expert_graphs/ensemble/reversal_high/cream_noisy_dags/expert_0.csv"
if [ ! -f "$DAG_CSV" ]; then
...
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/celeba/cream_noisy_ensemble/cream_noisy_reversal_high_expert0.yaml
echo "Done!"
