...
DAG_CSV="$PROJECT_ROOT/data/CelebA/expert_graphs/ensemble/deletion_low/cream_noisy_dags/expert_2.csv"
if [ ! -f "$DAG_CSV" ]; then
...
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/celeba/cream_noisy_ensemble/cream_noisy_deletion_low_expert2.yaml
echo "Done!"
