...
DAG_CSV="$PROJECT_ROOT/data/CelebA/expert_graphs/ensemble/addition_high/cream_noisy_dags/expert_1.csv"
if [ ! -f "$DAG_CSV" ]; then
...
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/celeba/cream_noisy_ensemble/cream_noisy_addition_high_expert1.yaml
echo "Done!"
