...
echo "=============================================="
echo "mCREAM: GraphMLP (M=10, High) - CELEBA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
save_expert_graphs(expert_u2c, expert_c2y, '$EXPERT_DIR', {'disagreement_level': 'high', 'num_experts': 10})
print('Expert graphs saved!')
"
fi

echo ""
echo "Running mCREAM with GraphMLP aggregation (M=10, high)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/graph_mlp/graph_mlp_M10_high.yaml
