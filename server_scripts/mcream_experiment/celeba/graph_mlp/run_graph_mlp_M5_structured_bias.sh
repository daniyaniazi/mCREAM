...
echo "=============================================="
echo "mCREAM: GraphMLP (M=5, Structured Bias) - CELEBA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/graph_mlp/graph_mlp_M5_structured_bias.yaml
