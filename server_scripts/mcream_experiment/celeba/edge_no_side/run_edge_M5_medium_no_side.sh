...
echo "=============================================="
echo "mCREAM: Edge Aggregation (M=5, Medium) - CelebA - NO SIDE CHANNEL"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/edge_no_side/edge_M5_medium_no_side.yaml
