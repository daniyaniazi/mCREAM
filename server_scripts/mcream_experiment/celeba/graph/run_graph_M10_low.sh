...
echo "=============================================="
echo "mCREAM: Graph (M=10, Low) - CELEBA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Graph aggregation (M=10, low)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/graph/graph_M10_low.yaml
