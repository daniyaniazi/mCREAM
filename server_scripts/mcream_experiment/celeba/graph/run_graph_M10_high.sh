...
echo "=============================================="
echo "mCREAM: Graph (M=10, High) - CELEBA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Graph aggregation (M=10, high)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/graph/graph_M10_high.yaml
