...
echo "=============================================="
echo "mCREAM: Union Baseline (M=5, Medium) - CelebA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Union aggregation..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/baselines/union_M5_medium.yaml
