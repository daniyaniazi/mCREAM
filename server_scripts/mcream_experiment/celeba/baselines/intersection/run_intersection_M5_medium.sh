...
echo "=============================================="
echo "mCREAM: Intersection Baseline (M=5, Medium) - CelebA"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/celeba/baselines/intersection_M5_medium.yaml
