...
echo "================================================"
echo "mCREAM Ensemble: celeba | soft_average | addition | high"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/celeba/no_side/no_side_soft_average_addition_high.yaml
