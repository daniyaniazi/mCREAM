...
echo "================================================"
echo "mCREAM Ensemble: celeba | weighted | deletion | medium"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM Ensemble (weighted, deletion, medium)..."
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/celeba/no_side/no_side_weighted_deletion_medium.yaml
