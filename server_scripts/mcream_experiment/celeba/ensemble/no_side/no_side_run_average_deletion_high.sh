...
echo "================================================"
echo "mCREAM Ensemble: celeba | average | deletion | high"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM Ensemble (average, deletion, high)..."
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/celeba/no_side/no_side_average_deletion_high.yaml
