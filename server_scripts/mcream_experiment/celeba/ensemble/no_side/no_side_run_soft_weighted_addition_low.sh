...
echo "================================================"
echo "mCREAM Ensemble: celeba | soft_weighted | addition | low"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
EXPERT_DIR="$PROJECT_ROOT/data/CelebA/expert_graphs/ensemble/addition_low"
...
echo ""
echo "Running mCREAM Ensemble (soft_weighted, addition, low)..."
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/celeba/no_side/no_side_soft_weighted_addition_low.yaml
