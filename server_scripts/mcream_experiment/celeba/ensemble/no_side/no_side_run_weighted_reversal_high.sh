...
echo "================================================"
echo "mCREAM Ensemble: celeba | weighted | reversal | high"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM Ensemble (weighted, reversal, high)..."
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/celeba/no_side/no_side_weighted_reversal_high.yaml
