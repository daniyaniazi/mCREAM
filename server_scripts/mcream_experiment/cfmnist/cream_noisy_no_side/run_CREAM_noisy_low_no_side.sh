...
echo Running: CREAM_noisy_low_no_side
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/cfmnist/cream_noisy_no_side/CREAM_noisy_low_no_side.yaml
echo Done!