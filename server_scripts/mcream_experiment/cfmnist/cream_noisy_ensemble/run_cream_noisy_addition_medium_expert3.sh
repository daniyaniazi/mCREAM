...
DAG_CSV="$PROJECT_ROOT/data/FashionMNIST/expert_graphs/ensemble/addition_medium/cream_noisy_dags/expert_3.csv"
if [ ! -f "$DAG_CSV" ]; then
...
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/cfmnist/cream_noisy_ensemble/cream_noisy_addition_medium_expert3.yaml
echo "Done!"
