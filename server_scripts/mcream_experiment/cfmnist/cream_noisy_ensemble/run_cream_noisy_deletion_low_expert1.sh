...
DAG_CSV="$PROJECT_ROOT/data/FashionMNIST/expert_graphs/ensemble/deletion_low/cream_noisy_dags/expert_1.csv"
if [ ! -f "$DAG_CSV" ]; then
...
"$PYTHON_BIN" simple_main.py --config all_configs/mcream_configs/cfmnist/cream_noisy_ensemble/cream_noisy_deletion_low_expert1.yaml
echo "Done!"
