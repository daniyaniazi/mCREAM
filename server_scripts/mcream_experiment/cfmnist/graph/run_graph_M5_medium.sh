...
echo "=============================================="
echo "mCREAM: Graph-level Aggregation (M=5, Medium)"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Graph aggregation (medium)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph/graph_M5_medium.yaml
