...
echo "=============================================="
echo "mCREAM: Graph-level with Structured Expert Bias"
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph/graph_M5_structured_bias.yaml
