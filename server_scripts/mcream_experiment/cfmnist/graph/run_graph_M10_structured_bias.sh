...
echo "=============================================="
echo "mCREAM: Graph (M=10, Structured Bias) - CFMNIST"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph/graph_M10_structured_bias.yaml
