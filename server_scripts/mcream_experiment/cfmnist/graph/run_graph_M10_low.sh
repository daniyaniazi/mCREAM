...
echo "=============================================="
echo "mCREAM: Graph (M=10, Low) - CFMNIST"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
EXPERT_DIR="$PROJECT_ROOT/data/FashionMNIST/expert_graphs/M10/low"
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph/graph_M10_low.yaml
