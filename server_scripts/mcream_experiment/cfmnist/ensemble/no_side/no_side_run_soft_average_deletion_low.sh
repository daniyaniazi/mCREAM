...
echo "================================================"
echo "mCREAM Ensemble: cfmnist | soft_average | deletion | low"
echo "================================================"
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM Ensemble (soft_average, deletion, low)..."
"$PYTHON_BIN" mcream_ensemble_main.py     --config all_configs/mcream_ensemble_configs/cfmnist/no_side/no_side_soft_average_deletion_low.yaml
