...
echo "=============================================="
echo "mCREAM: GraphMLP (M=10, Structured Bias) - CFMNIST"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
EXPERT_DIR="$PROJECT_ROOT/data/FashionMNIST/expert_graphs/M10/structured_bias"
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph_mlp/graph_mlp_M10_structured_bias.yaml
