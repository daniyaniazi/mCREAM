...
echo "=============================================="
echo "mCREAM: Graph Aggregation (M=5, Medium) - cfmnist - NO SIDE CHANNEL"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Graph aggregation (no side channel)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph_no_side/graph_M5_medium_no_side.yaml
