...
echo Running: graph_M5_structured_bias_no_side
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/graph_no_side/graph_M5_structured_bias_no_side.yaml
echo Done!