...
echo "Running mCREAM Graph Ensemble (reversal/low)..."
"$PYTHON_BIN" mcream_graph_ensemble_main.py     --config all_configs/mcream_graph_ensemble_configs/cfmnist/reversal/graph_ensemble_reversal_low.yaml
echo "Done!"
