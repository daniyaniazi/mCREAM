...
echo "Running mCREAM Graph Ensemble (reversal/medium)..."
"$PYTHON_BIN" mcream_graph_ensemble_main.py     --config all_configs/mcream_graph_ensemble_configs/cfmnist/reversal/graph_ensemble_reversal_medium.yaml
echo "Done!"
