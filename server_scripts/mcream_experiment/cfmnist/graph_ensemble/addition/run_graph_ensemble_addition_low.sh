...
echo "Running mCREAM Graph Ensemble (addition/low)..."
"$PYTHON_BIN" mcream_graph_ensemble_main.py     --config all_configs/mcream_graph_ensemble_configs/cfmnist/addition/graph_ensemble_addition_low.yaml
echo "Done!"
