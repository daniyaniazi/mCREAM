...
echo "Running mCREAM Graph Ensemble (addition/high)..."
"$PYTHON_BIN" mcream_graph_ensemble_main.py     --config all_configs/mcream_graph_ensemble_configs/cfmnist/addition/graph_ensemble_addition_high.yaml
echo "Done!"
