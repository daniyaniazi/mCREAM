...
echo "Running mCREAM Graph Ensemble (addition/medium)..."
"$PYTHON_BIN" mcream_graph_ensemble_main.py     --config all_configs/mcream_graph_ensemble_configs/cfmnist/addition/graph_ensemble_addition_medium.yaml
echo "Done!"
