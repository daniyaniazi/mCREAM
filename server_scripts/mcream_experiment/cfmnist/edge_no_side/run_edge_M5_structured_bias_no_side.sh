...
echo Running: edge_M5_structured_bias_no_side
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/edge_no_side/edge_M5_structured_bias_no_side.yaml
echo Done!