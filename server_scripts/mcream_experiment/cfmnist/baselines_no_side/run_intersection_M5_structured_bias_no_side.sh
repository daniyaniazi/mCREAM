...
echo Running: intersection_M5_structured_bias_no_side
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/baselines_no_side/intersection_M5_structured_bias_no_side.yaml
echo Done!