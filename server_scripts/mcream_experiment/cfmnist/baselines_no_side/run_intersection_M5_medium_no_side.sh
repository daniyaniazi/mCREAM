...
echo "=============================================="
echo "mCREAM: Intersection Baseline (M=5, Medium) - cfmnist - NO SIDE CHANNEL"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/baselines_no_side/intersection_M5_medium_no_side.yaml
