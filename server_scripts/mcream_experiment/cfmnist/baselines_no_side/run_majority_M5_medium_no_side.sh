...
echo "=============================================="
echo "mCREAM: Majority Vote Baseline (M=5, Medium) - cfmnist - NO SIDE CHANNEL"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running mCREAM with Majority Vote aggregation (no side channel)..."
"$PYTHON_BIN" mcream_main.py --config all_configs/mcream_configs/cfmnist/baselines_no_side/majority_M5_medium_no_side.yaml
