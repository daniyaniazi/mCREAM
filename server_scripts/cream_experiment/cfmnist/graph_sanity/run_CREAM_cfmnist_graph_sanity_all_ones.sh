...
CONFIG_PATH="all_configs/sanity_checks/cfmnist_graph_sanity/CREAM_cfmnist_graph_sanity_all_ones.yaml"
...
echo "Running Complete_Concept_FMNIST CREAM graph sanity variant: all_ones"
