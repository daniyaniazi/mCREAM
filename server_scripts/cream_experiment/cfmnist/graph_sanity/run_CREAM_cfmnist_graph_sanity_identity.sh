...
CONFIG_PATH="all_configs/sanity_checks/cfmnist_graph_sanity/CREAM_cfmnist_graph_sanity_identity.yaml"
...
echo "Running Complete_Concept_FMNIST CREAM graph sanity variant: identity"
