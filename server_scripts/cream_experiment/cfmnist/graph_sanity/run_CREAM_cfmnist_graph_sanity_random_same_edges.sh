...
CONFIG_PATH="all_configs/sanity_checks/cfmnist_graph_sanity/CREAM_cfmnist_graph_sanity_random_same_edges.yaml"
...
echo "Running Complete_Concept_FMNIST CREAM graph sanity variant: random_same_edges"
