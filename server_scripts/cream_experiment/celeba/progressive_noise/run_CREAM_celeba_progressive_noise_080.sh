...
CONFIG_PATH="all_configs/sanity_checks/celeba_progressive_noise/CREAM_celeba_progressive_noise_080.yaml"
...
echo "Running CelebA CREAM progressive graph noise: 80%"
