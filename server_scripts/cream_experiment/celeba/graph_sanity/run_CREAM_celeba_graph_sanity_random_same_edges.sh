...
CONFIG_PATH="all_configs/sanity_checks/celeba_graph_sanity/CREAM_celeba_graph_sanity_random_same_edges.yaml"
...
echo "Running CelebA CREAM graph sanity variant: random_same_edges"
