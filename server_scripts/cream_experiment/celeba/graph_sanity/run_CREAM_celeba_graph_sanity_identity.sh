...
CONFIG_PATH="all_configs/sanity_checks/celeba_graph_sanity/CREAM_celeba_graph_sanity_identity.yaml"
...
echo "Running CelebA CREAM graph sanity variant: identity"
