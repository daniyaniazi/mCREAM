...
CONFIG_PATH="all_configs/sanity_checks/celeba_graph_sanity/CREAM_celeba_graph_sanity_all_ones.yaml"
...
echo "Running CelebA CREAM graph sanity variant: all_ones"
