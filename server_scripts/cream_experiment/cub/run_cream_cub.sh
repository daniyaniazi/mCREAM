...
echo "=============================================="
echo "CREAM Baseline - CUB (200 bird species)"
echo "Ground truth DAG, group_soft, 112 concepts"
echo "=============================================="
echo "HOST=$(hostname)"
"$PYTHON_BIN" -V
nvidia-smi || true
...
echo ""
echo "Running CREAM on CUB..."
"$PYTHON_BIN" simple_main.py --config all_configs/best_hparams/CREAM/CREAM_best_cub_soft_config.yaml
